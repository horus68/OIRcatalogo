...
<head>
	...
	<meta name="description" content="Créditos e informações - XPTO - Catálogo coletivo da Rede de Bibliotecas do concelho" />
	...
	<!-- OpenGraph Facebook -->
	<meta property="og:title" content="Créditos - XPTO - Rede de bibliotecas" />
				...
				<div class="destaquetexto1">
					...
					<dl>
						...
						<dd>Atividades e recursos - Visitar sítio
							<br>
							<a href="<%=surlPORTAL%>" target="_blank" rel="noopener"><span class="fa-layers fa-fw" style="font-size:2em"><i class="fas fa-circle-notch"></i><i class="fas fa-external-link-alt" data-fa-transform="shrink-9" alt="Notícias das bibliotecas" title="Notícias das bibliotecas"></i></span>Sítio web da rede</a></dd>
						<br>
						...
						<dl>
							...
							<dd>
								<a href="https://sites.google.com/view/pesquisarcatalogo/" target="_blank" rel="noopener">
									<span class="fa-layers fa-fw" style="font-size:2em"><i class="fas fa-circle-notch"></i><i class="fas fa-external-link-alt" data-fa-transform="shrink-9" title="Sítio de apoio a utilizadores" title="Sítio de apoio à utilização do Catálogo"></i></span>Apoio à utilização do Catálogo</a>
							</dd>
							<br>
							<dt>Apoio a bibliotecários</dt>
							<dd>
								<a href="https://sites.google.com/view/opacrbe/biblio" target="_blank" rel="noopener">
									<span class="fa-layers fa-fw" style="font-size:2em"><i class="fas fa-circle-notch"></i><i class="fas fa-external-link-alt" data-fa-transform="shrink-9" alt="Sítio de apoio a bibliotecários" title="Bibliotecários - Sítio de apoio"></i></span>Administração e utilização do Catálogo</a>
							</dd>
							<br>
							<dt>Apoio a técnicos de informática</dt>
							<dd><a href="https://sites.google.com/view/opacrbe/tec" target="_blank" rel="noopener"><span class="fa-layers fa-fw" style="font-size:2em"><i class="fas fa-circle-notch"></i><i class="fas fa-external-link-alt" data-fa-transform="shrink-9" title="Sítio de apoio a técnicos" title="Técnicos - Sítio de apoio"></i></span>Instalação e manutenção do Catálogo</a></dd>
						</dl>
						<br>
					</div>
