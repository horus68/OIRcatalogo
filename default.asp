...
-->
  ...
  <%if Session("LoggedIn") then %><br /><a href="admin/admin.asp" rel="nofollow"><span class="fa-layers fa-fw" style="font-size:1.5em"><i class="fas fa-circle-notch" ></i><i class="fas fa-cog" data-fa-transform="shrink-8" title="Administração"></i></span>Ir para zona de administração</a> <% end if%>
</div><% end if%>
...
<div class="col1-contentor" style="text-align:center;" >
  <div class="col1">
    ...
    <p><a href="catpesq.asp?id=0&bd=col" alt="Pesquisa rápida" title="Pesquisa tudo"><span class="fa-layers fa-fw" style="font-size:6.0em"><i class="fas fa-circle-notch" ></i><i class="fab fa-searchengin" data-fa-transform="shrink-7"></i></span></a><br />
  ...
  <div class="col1">
    ...
    Exatidão. Para quando se sabe o que se pretende encontrar<br />
  ...
  <div class="col1">
    ...
    Organização. Navegar no catálogo sem ter de escrever<br />
 ...
 <!--<% if ucase(session("user"))="ADMIN" or session("LeitorIn") then %>
  <div class="col1">
    ...
    Etiquetas criadas pelos leitores<br /><i>(disponível apenas a leitores autenticados)</i></p>
  </div><%end if%>-->
</div>
...
<div class="col-contentor">
  <div class="col">
		  <%
		   ...
		   %>
		   <fieldset style="margin:5px 5px 0 0;padding:5px"><legend>Top títulos</legend>
		     <br />
...
<!-- Segmento Extra -->
  ...
  Conheça ainda as <b>atividades</b> das nossas bibliotecas ao visitar o nosso <b>portal</b>.
  </p>
  </div>
<!-- Segmento Extra FIM -->
<!-- Segmento Logótipo -->
...
<div class="col2-contentor">
  <div class="col2">
<p class="rodape" align="center" style="font-variant: small-caps"><a style="text-decoration:none" href="creditos.asp">Infos e Créditos do Catálogo Coletivo:<br> &copy; <b><%=sentidadelonga%> </b><span class="fa-layers fa-fw" style="font-size:1.3em"><i class="fas fa-circle-notch" ></i><i class="fas fa-info" data-fa-transform="shrink-8" title="Informações técnicas e créditos do catálogo"></i></span></a></p>
  </div>
  <div class="col2">
<p class="rodape" align="center"><a style="text-decoration:none" href="creditos.asp"><img src="imagens/logotipo.png" alt="Logótipo da Rede" title="Logótipo da Rede" border=0 align="absmiddle" hspace="3"></a></p>
  </div>
  <div class="col2">
<p class="rodape" align="center" style="font-variant: small-caps"><a style="text-decoration:none" href="<%=surlPORTAL%>" target="_top">Portal de atividades e notícias da Rede: <br> <b><%=sentidadelonga%></b><span class="fa-layers fa-fw" style="font-size:1.3em"><i class="fas fa-circle-notch" ></i><i class="fas fa-external-link-alt" data-fa-transform="shrink-9" title="Notícias das bibliotecas"></i></span></a></p>
  </div>
  </div>
...
-->
  ...
  <div class="navega">
      <p>» <% if session("user")="" then response.write "<b>Área reservada:</b> " else response.write "Utilizador: " &  DecodeUTF8(session("user"))%>
...
<br />
<%if Session("LoggedIn") then %> » <a href="admin/admin.asp" rel="nofollow">Ir para zona de administração</a><% end if%></p>
  </div>
