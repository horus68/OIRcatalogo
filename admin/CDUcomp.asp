...
%>
 ...
 var valores="<%=strBibs%>";	
	...
	var t=valores.split(",");
	 ...
	 {     
			eval("s"+k+" = [['0 Generalidades. Informática', "+t[i++]+"], ['1 Filosofia. Psicologia', "+t[i++]+"], ['2 Religião',"+t[i++]+"], ['3 Ciências Sociais',"+t[i++]+"],['4 Vazia',"+t[i++]+"], ['5 Ciências Exatas e Naturais',"+t[i++]+"], ['6 Ciências Aplicadas',"+t[i++]+"],['7 Artes e Desporto',"+t[i++]+"], ['8 Linguística. Literatura',"+t[i++]+"], ['9 Geografia. História',"+t[i]+"]]"); 
			k++;
	 }
