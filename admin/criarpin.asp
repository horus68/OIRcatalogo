...
<!-- Segmento Navegação topo -->
  <div class="col3-contentor">
    <div class="col3">
    <p class="fil">» <a href="../default.asp">Zona Pública</a> » <a href="admin.asp">Administração</a> » <a href="../cgi/www.exe/[in=pleitor.in]?ut=<%= lcase(SESSION("user")) %>&expressao=<%= REQUEST("expressao")%>"> Leitores </a> » Definição de permissões
</p>
    </div>
    <div class="col3" id="lblutilizador">Utilizador: <span id="utilizador"><%= SESSION("user") %> [ <a href="admin.asp?Logout=1">Sair</a> ]</span>
    </div>
  </div>
<!-- Segmento Navegação topo - FIM -->
      ...
      <div id="principal">
      <div id="admbotoes" style="float:right"><a href="javascript:voltar()"><img src="../imagens/picactions/icon_close.gif" border=0 title="Voltar à página anterior" alt="Voltar à página anterior"></a></div>
      <br>
	  <br>
