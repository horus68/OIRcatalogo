...
<h3>Avaliação das existências<div id="admbotoes" style="float:right"><a href="admin.asp?id=3"><img src="../imagens/picactions/icon_close.gif" border=0 title="Voltar à página anterior" alt="Voltar à página anterior"></a></div></h3>
    <div id="principal"> 
	   <div style="border:solid 1px #999">
		 ...
		 %>
<h4><% if request("criterio")="X" then  response.write "Toda a rede" else response.write "Instituição: " & ucase(request("users")) & " (" & siglaEXT & ")"  end if%></h4>
