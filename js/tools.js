...
function submitNS()
{
	   ...
	   {
	     document.getElementById("frmlogin").action="/rbcatalogo/login.asp?Logout.asp";
	   }
}
...
function validar()
     {
	   ...
	   {   var browserName=navigator.appName;
		   if (browserName=="Microsoft Internet Explorer")
			...
			{ 
             window.location.href="/rbcatalogo/logout.asp?referr=NS";
			}
            ...
            xmlhttp.onreadystatechange = function() {
				...
				switch (retorno)
				{
				  case "":
							...
							document.getElementById("utilizador").innerText='Visitante';
